    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-gray-900 dark:text-white">
        <h1 className="text-4xl font-bold mb-8 text-center">
          Microsoft AI & Robotics Literacy Program – Empowering the Next Generation of Innovators
        </h1>
        <p className="text-lg leading-relaxed mb-8">
          The Microsoft AI & Robotics Literacy Program is a year-round national initiative aimed at equipping Kenyan high school students with 21st-century skills in Artificial Intelligence (AI), robotics, coding, and digital fabrication.
        </p>
        <p className="text-lg leading-relaxed mb-8">
        ...
        <p className="mb-8">
          🏫 These schools were carefully pre-selected as part of the pilot phase of the Microsoft AI Literacy Program. Selection was guided by a mix of strategic factors:
        </p>
        <ul className="list-disc list-inside mb-8 space-y-2">
          <li>Strong STEM track record and demonstrated commitment to innovation</li>
          <li>Infrastructure readiness to support advanced robotics and AI activities</li>
          <li>Ongoing collaboration with Microsoft, CHIPUROBO, and eKitabu in past digital learning initiatives</li>
          <li>Geographic accessibility to the Microsoft ADC Garage in Westlands, Nairobi</li>
          <li>Diversity and inclusivity, ensuring representation across both national and county-level institutions, as well as gender-balanced student bodies</li>
        </ul>
        <p className="mb-8">
          This pilot cohort sets the foundation for a larger, nationwide rollout. Insights and feedback from these initial schools will directly inform the program’s scale-up strategy throughout 2025 and beyond.
        </p>
