...
const About = () => {
  const achievements = [
    ...
    },
    {
      ...
      description: "Internationally recognized STEM education programs"
    },
    {
      icon: Rocket,
      title: "100+ Robots",
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
      <div className="text-center mb-16">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">About ChipuRobo</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-24">
        <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
          <Target className="h-12 w-12 text-green-600 dark:text-green-500 mb-4" />
        ...
        <div className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md">
          <Lightbulb className="h-12 w-12 text-green-600 dark:text-green-500 mb-4" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {achievements.map((achievement, index) => (
            <div key={index} className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-md text-center">
              <achievement.icon className="h-12 w-12 text-green-600 dark:text-green-500 mx-auto mb-4" />
