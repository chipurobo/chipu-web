  ...
  return (
    <section className="relative overflow-hidden bg-warm-50 dark:bg-gray-900">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-16 sm:pt-20 sm:pb-20 text-center">
        ...
        <h1 className="heading-display text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-gray-900 dark:text-white mb-6 leading-[1.2]">
          {title}
        </h1>
        {subtitle && (
      ...
      <div className="border-t border-warm-200 dark:border-gray-800" aria-hidden="true" />
    </section>
  );
};
