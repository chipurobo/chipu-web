...
const Contact = () => {
 ...
 <div className="bg-white rounded-xl shadow-soft-md border border-gray-100 p-8 h-fit sticky top-24">
 <div className="text-center mb-8">
 <h2 className="text-xl font-semibold text-gray-900 mb-2">Get In Touch</h2>
 <p className="text-gray-600 text-sm">We're here to help you bring innovation to your classroom</p>
 </div>
 ...
 <p className="font-medium text-blue-900 text-sm mb-1">Primary Email</p>
 <a
 href="mailto:chipurobo@gmail.com"
 className="text-blue-700 hover:text-blue-800 transition-colors text-sm break-all"
 >
 chipurobo@gmail.com
 </a>
 <p className="text-blue-600/70 text-xs mt-1">Response within 48 hours</p>
 </div>
 </div>
 </div>
 ...
 <div className="flex-1">
 <p className="font-medium text-purple-900 text-sm mb-1">Location</p>
 <p className="text-purple-700 text-sm">Nairobi Railway Museum</p>
 <p className="text-purple-600/70 text-xs mt-1">Serving all 47 counties</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <h3 className="text-sm font-semibold text-gray-900 mb-4 text-center">Connect With Us</h3>
 <div className="flex justify-center space-x-3">
 <a
 href="#"
 className="p-2.5 rounded-full bg-gray-100 text-gray-500 hover:bg-blue-50 hover:text-blue-600 transition-all duration-200"
 ...
 <a
 href="#"
 className="p-2.5 rounded-full bg-gray-100 text-gray-500 hover:bg-purple-50 hover:text-purple-600 transition-all duration-200"
 ...
 <a
 href="#"
 className="p-2.5 rounded-full bg-gray-100 text-gray-500 hover:bg-gray-200 hover:text-gray-900 transition-all duration-200"
 ...
 {/* Email Instructions */}
 <div className="bg-gradient-to-r from-primary-50 to-blue-50 rounded-xl p-8 mb-8 border border-primary-100 ">
 ...
 blue: { bg: 'bg-blue-50 ', iconBg: 'from-blue-500 to-blue-600', badge: 'text-blue-900 ', dot: 'bg-blue-500', text: 'text-blue-800 ', border: 'border-blue-100 ' },
 green: { bg: 'bg-green-50 ', iconBg: 'from-green-500 to-green-600', badge: 'text-green-900 ', dot: 'bg-green-500', text: 'text-green-800 ', border: 'border-green-100 ' },
 purple: { bg: 'bg-purple-50 ', iconBg: 'from-purple-500 to-purple-600', badge: 'text-purple-900 ', dot: 'bg-purple-500', text: 'text-purple-800 ', border: 'border-purple-100 ' },
 };
 const c = colorMap[inquiry.color];

 return (
 <div key={index} className="bg-white rounded-xl shadow-soft-sm border border-gray-100 p-7 hover:shadow-soft-md transition-all duration-300 hover:-translate-y-0.5">
 <div className="flex items-start">
 ...
 <div className="flex-1">
 <h4 className="text-lg font-semibold text-gray-900 mb-3">{inquiry.title}</h4>
