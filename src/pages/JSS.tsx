      ...
      <section className="relative overflow-hidden bg-warm-50 dark:bg-gray-900 border-b border-warm-200 dark:border-gray-800">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 lg:py-32">
          <div className="text-center text-white">
            ...
            <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-3 heading-display text-gray-900 dark:text-white">JSS Cyberbrick League</h1>
      ...
      <section className="pb-20 sm:pb-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid gap-6 md:grid-cols-2">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-100 dark:border-gray-700/50 shadow-soft-md transition-all duration-300 hover:shadow-soft-lg hover:-translate-y-1.5">
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 flex items-center heading-display">
