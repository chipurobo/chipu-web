...
const JSS = () => {
 ...
 <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-3 heading-display text-gray-900 ">JSS Cyberbrick League</h1>
 ...
 {phases.map((phase) => (
 <article key={phase.title} className="bg-white rounded-xl p-6 border border-gray-100 shadow-soft-md transition-all duration-300 hover:shadow-soft-lg hover:-translate-y-1.5">
 <h2 className="text-xl font-semibold text-gray-900 mb-2">{phase.title}</h2>
 ...
 {quickFacts.map((fact) => (
 <div key={fact.label} className="bg-gradient-to-br from-gray-50 to-white rounded-xl p-5 border border-gray-100 text-center transition-all duration-300">
 <p className="text-xs uppercase text-teal-600 tracking-wide">{fact.label}</p>
 ...
 <h3 className="text-xl font-semibold text-gray-900 mb-3 flex items-center heading-display">
 <Gamepad2 className="h-5 w-5 text-teal-600 mr-2" />
 Weekly Rhythm
 </h3>
 ...
 <h3 className="text-3xl font-semibold tracking-tight mb-3 heading-display">Kick Off the League</h3>
 ...
 <button className="bg-terracotta-500 hover:bg-terracotta-600 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-200 hover:shadow-soft-xl">Notify Me</button>
