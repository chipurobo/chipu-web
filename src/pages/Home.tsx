...
const Home = () => {
  ...
  return (
    <div className="bg-warm-50 dark:bg-gray-900">
      ...
      <div className="bg-warm-50 dark:bg-gray-900 flex justify-center pt-6 pb-2 px-4">
        <Link
          to="/braille-challenge"
          className="group inline-flex items-center gap-2 bg-gray-800 dark:bg-gray-700 text-white text-sm px-5 py-2.5 rounded-full hover:bg-gray-700 dark:hover:bg-gray-600 transition-colors"
        >
      ...
      <section className="relative overflow-hidden bg-warm-50 dark:bg-gray-900">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8 text-center">
          <h1 className="heading-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-gray-900 dark:text-white mb-8 leading-[1.15]">
          ...
          <p className="text-base sm:text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto mb-10 leading-relaxed">
      ...
      <section className="py-12 border-t border-warm-200 dark:border-gray-800">
        <p className="text-center text-gray-400 dark:text-gray-500 text-xs tracking-[0.2em] uppercase mb-8">
        ...
        <div className="max-w-5xl mx-auto px-4 overflow-hidden">
          <div className="flex gap-12 animate-scroll items-center justify-center">
            {[...partners, ...partners].map((p, i) => (
              <span key={i} className="text-lg sm:text-xl font-bold text-gray-500 dark:text-gray-400 whitespace-nowrap flex-shrink-0 hover:text-gray-700 dark:hover:text-gray-200 transition-colors">
                {p.name}
              </span>
            ))}
          </div>
      ...
      {/* ── Mission Quote ── */}
      <section className="section bg-warm-50 dark:bg-gray-900" aria-labelledby="mission-title">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-800 p-10 sm:p-14 rounded-2xl shadow-soft-md border border-gray-100 dark:border-gray-700/50">
            <div className="flex items-start gap-5 mb-8">
              ...
              <div>
                <h2 id="mission-title" className="heading-display text-2xl text-gray-900 dark:text-white mb-4">Our Mission</h2>
      ...
      <section className="relative overflow-hidden bg-gray-900 dark:bg-black py-24 sm:py-32 scanlines circuit-grid">
