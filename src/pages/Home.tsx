...
const Home = () => {
  ...
  return (
    <div className="bg-warm-50 dark:bg-gray-900">
      ...
      {/* ── Announcement Banner ── */}
      <div className="bg-warm-50 dark:bg-gray-900 flex justify-center pt-6 pb-2">
        <Link
          to="/finsec"
          className="inline-flex items-center gap-2 bg-gray-800 dark:bg-gray-700 text-white text-sm px-5 py-2.5 rounded-full hover:bg-gray-700 dark:hover:bg-gray-600 transition-colors"
        >
          <span className="text-amber-400">🔗</span>
          <span>FinSec Hackathon: April 16–18 — Register Now</span>
          <ArrowRight className="h-3.5 w-3.5" />
        </Link>
      </div>

      {/* ── Hero ── */}
      <section className="relative overflow-hidden bg-warm-50 dark:bg-gray-900">
        {/* Faded code background */}
        <div className="code-bg absolute inset-0 opacity-40 dark:opacity-20" aria-hidden="true" />

        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-8 text-center">
          <h1 className="heading-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-gray-900 dark:text-white mb-6 leading-[1.1]">
            Where Africa Builds{' '}
            <span className="text-gray-400 dark:text-gray-500">the Future</span>
          </h1>

          <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed">
            Empowering 4 million youth across Africa by 2030 through hands-on AI, robotics, and sustainable innovation — CBC aligned, inclusive, and locally fabricated.
          </p>
      ...
      {/* ── Partners Marquee ── */}
      <section className="py-12 border-t border-warm-200 dark:border-gray-800">
        <p className="text-center text-gray-400 dark:text-gray-500 text-sm tracking-wide uppercase mb-8">
        ...
        <div className="max-w-5xl mx-auto px-4 overflow-hidden">
          <div className="flex gap-12 animate-scroll items-center justify-center">
            {[...partners, ...partners].map((p, i) => (
              <span key={i} className="text-lg sm:text-xl font-semibold text-gray-400 dark:text-gray-500 whitespace-nowrap flex-shrink-0 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
                {p.name}
              </span>
            ))}
          </div>
      ...
      <section className="section-alt code-bg">
        <div className="container relative">
          <div className="text-center mb-16">
            <h2 className="heading-display text-3xl sm:text-4xl md:text-5xl text-gray-900 dark:text-white mb-4">
              Building Better <span className="text-gray-400 dark:text-gray-500">Learning Workflows</span>
              <br />for Robotics
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {useCases.map((uc, i) => {
              const colors = [
                { bg: 'bg-emerald-50 dark:bg-emerald-900/20', text: 'text-emerald-600 dark:text-emerald-400', impact: 'text-emerald-600 dark:text-emerald-400' },
                { bg: 'bg-teal-50 dark:bg-teal-900/20', text: 'text-teal-600 dark:text-teal-400', impact: 'text-teal-600 dark:text-teal-400' },
                { bg: 'bg-amber-50 dark:bg-amber-900/20', text: 'text-amber-600 dark:text-amber-400', impact: 'text-amber-600 dark:text-amber-400' },
              ][i];
              return (
                <article key={i} className="bg-white dark:bg-gray-800 rounded-xl p-8 border border-gray-100 dark:border-gray-700/50 shadow-soft-sm hover:shadow-soft-md hover:-translate-y-1 transition-all duration-300">
                  <div className={`${colors.bg} inline-flex p-3 rounded-xl mb-5`}>
                    <uc.icon className={`h-6 w-6 ${colors.text}`} aria-hidden="true" />
                  </div>
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">{uc.title}</h3>
                  <p className="text-gray-600 dark:text-gray-400 text-sm mb-4 leading-relaxed">{uc.description}</p>
      ...
      {/* ── Featured Stories ── */}
      <section className="section bg-warm-50 dark:bg-gray-900">
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="heading-display text-3xl sm:text-4xl md:text-5xl text-gray-900 dark:text-white mb-4">
              Latest From <span className="text-gray-400 dark:text-gray-500">ChipuRobo</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {featuredPosts.map((post) => (
              <Link key={post.id} to={`/blog/${post.id}`} className="group">
                <article className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700/50 overflow-hidden h-full transition-all duration-300 hover:-translate-y-1.5 hover:shadow-soft-lg">
                  ...
                  <div className="p-6">
                    ...
                    <span className="inline-flex items-center text-terracotta-600 dark:text-terracotta-400 font-medium text-sm">
                      Read More
          ...
          <div className="text-center">
            <Link
              to="/blog"
              className="inline-flex items-center text-gray-900 dark:text-white hover:text-terracotta-600 dark:hover:text-terracotta-400 text-lg font-semibold transition-colors"
            >
              View All Articles
      ...
      {/* ── 2025 Achievements ── */}
      <section className="section bg-warm-100 dark:bg-gray-800/50">
        <div className="container">
          <div className="text-center mb-16">
            <h2 className="heading-display text-3xl sm:text-4xl md:text-5xl text-gray-900 dark:text-white mb-4">
              2025: A Year of <span className="text-gray-400 dark:text-gray-500">Transformation</span>
            </h2>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {[
              ...
              <div key={i} className="bg-white dark:bg-gray-800 p-6 rounded-xl border border-gray-100 dark:border-gray-700/50 text-center">
                <div className="text-3xl font-bold text-teal-600 dark:text-teal-400 mb-2">{s.val}</div>
                <div className="text-gray-700 dark:text-gray-300 text-sm font-medium mb-1">{s.label}</div>
                <div className="text-xs text-gray-500">{s.sub}</div>
              </div>
            ))}
          </div>

          <div className="bg-gray-900 dark:bg-black rounded-2xl p-8 sm:p-10 text-center">
      ...
      {/* ── Innovation Pillars ── */}
      <section className="section bg-gray-900 dark:bg-black text-white">
        <div className="container">
          <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {pillars.map((p, i) => (
              ...
              >
                ...
                <h4 className="text-lg font-semibold text-white mb-3">{p.title}</h4>
      ...
      <section className="section bg-warm-50 dark:bg-gray-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white dark:bg-gray-800 p-10 sm:p-14 rounded-2xl shadow-soft-md border border-gray-100 dark:border-gray-700/50">
            <div className="flex items-start gap-5 mb-8">
              <div className="bg-teal-50 dark:bg-teal-900/30 p-3 rounded-xl flex-shrink-0">
                <Target className="h-10 w-10 text-teal-600 dark:text-teal-400" />
              </div>
              <div>
                <h3 className="heading-display text-2xl text-gray-900 dark:text-white mb-4">Our Mission</h3>
      ...
      {/* ── CTA ── */}
      <section className="relative overflow-hidden bg-gray-900 dark:bg-black py-24 sm:py-32">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          <p className="text-base text-gray-500 mb-10 max-w-2xl mx-auto">
            Join our mission to empower 4 million youth across Africa by 2030.
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Link to="/ksef" className="btn-cta text-lg">
              <Calendar className="mr-2 h-5 w-5" />
              KSEF 2026
            </Link>
            <Link
              to="/about"
              className="border-2 border-white/20 text-white px-8 py-3.5 rounded-lg font-semibold inline-flex items-center justify-center hover:bg-white/10 transition-all duration-200 text-lg"
            >
