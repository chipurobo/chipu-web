  ...
  const featuredPosts = [
    {
      ...
      excerpt:
        'Trained 130 students and 50 teachers in inclusive AI, robotics, and PET recycling workshops.',
    ...
    },
    {
      ...
      excerpt:
        '150+ learners and teachers built AI-powered robots and explored computer vision at Microsoft ADC.',
    ...
    },
    {
      ...
      excerpt:
        'PET recycling machines turn waste into 3D-printable robot parts while funding community programs.',
  ...
  const useCases = [
    {
      ...
      description:
        'KSEF teams built PET recycling machines that supply filament for ADC bootcamp prototypes.',
    ...
    },
    {
      ...
      description:
        'Student projects delivered Braille kits, KSL videos, and neurodiverse-friendly AI lessons.',
    ...
    },
    {
      ...
      description:
        'Students now design robots that sort materials with computer vision and solve campus tasks.',
  ...
  const pillars = [
    {
      ...
      description:
        'Develop AI solutions through sustainable digital fabrication, inclusive learning systems, and locally-relevant automation technologies.',
    },
    {
      icon: Robot,
      title: 'Local Innovation',
      description:
        'Create AI-powered robotics solutions using locally available resources and addressing regional needs.',
    },
    {
      icon: Heart,
      title: 'Community Impact',
      description:
        'Apply AI to solve real community challenges while preserving and enhancing African cultural values.',
    },
    {
      icon: Leaf,
      title: 'Sustainable Development',
      description:
        'Leverage AI for sustainable development goals while promoting environmental consciousness.',
    },
  ];
     ...
     headline cannot: which cycle, and that it is open right now. */}
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-20">
          <div className="relative bracket-frame-full bracket-corners-bottom">
            <div className="relative rounded-lg overflow-hidden shadow-soft-xl">
              ...
              <div
                className="cursor-badge cursor-badge-teal top-[20%] left-[15%] hidden sm:flex animate-float-gentle"
                aria-hidden="true"
              >
                STUDENT
              </div>
              <div
                className="cursor-badge cursor-badge-terracotta top-[10%] right-[10%] hidden sm:flex animate-float-gentle"
              ...
              <div
                className="cursor-badge cursor-badge-amber bottom-[25%] right-[20%] hidden sm:flex animate-float-gentle"
        ...
        <div className="max-w-5xl mx-auto px-4 overflow-hidden">
          <div className="flex gap-12 animate-scroll items-center justify-center">
            {[...partners, ...partners].map((p, i) => (
              <span
                key={i}
                className="text-lg sm:text-xl font-bold text-gray-500 whitespace-nowrap flex-shrink-0 hover:text-gray-700 transition-colors"
              >
                {p.name}
              </span>
            ))}
        ...
        <div className="container relative">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Students publish open-source hardware, software, and data — enabling others to
              rebuild, remix, and scale innovation across Africa.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto mb-20">
            <div className="relative bracket-frame-full bracket-corners-bottom">
              <div className="relative rounded-lg overflow-hidden">
                ...
                <div
                  className="cursor-badge cursor-badge-terracotta top-[15%] right-[8%] hidden sm:flex animate-float-gentle"
                  aria-hidden="true"
                >
                  BUILDER
                </div>
                <div
                  className="cursor-badge cursor-badge-teal bottom-[20%] left-[12%] hidden sm:flex animate-float-gentle"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {useCases.map((uc, i) => {
              ...
              return (
                <article
                  key={i}
                  className="bg-white rounded-xl p-8 border border-gray-100 shadow-soft-sm hover:shadow-soft-md hover:-translate-y-1 transition-all duration-300"
                >
              ...
              <Link key={post.id} to={`/blog/${post.id}`} className="group">
                <article className="bg-white rounded-xl border border-gray-100 overflow-hidden h-full transition-all duration-300 hover:-translate-y-1.5 hover:shadow-soft-lg">
                  <div className="relative h-52 overflow-hidden">
                    <picture>
                      <source
                        srcSet={post.image.replace(/\.(jpe?g|png)$/i, '.webp')}
                        type="image/webp"
                      />
                      <img
                        src={post.image}
                  ...
                  <div className="p-6">
                    ...
                    <span
                      className="inline-flex items-center text-terracotta-600 font-medium text-sm"
                      aria-hidden="true"
                    >
                      Read More
                      <ArrowRight
      ...
      <section className="section bg-warm-100 ">
        <div className="container">
          ...
          <div className="bg-gray-900 rounded-2xl p-8 sm:p-10 text-center">
            <h3 className="heading-display text-2xl sm:text-3xl text-white mb-4">
              Microsoft ADC Partnership Impact
            </h3>
        ...
        <div className="container">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-400 max-w-3xl mx-auto">
              We teach robotics while building Africa's innovation ecosystem through AI-driven
              education.
            </p>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white p-10 sm:p-14 rounded-2xl shadow-soft-md border border-gray-100 ">
            <div className="flex items-start gap-5 mb-8">
              ...
              <div>
                <h2 id="mission-title" className="heading-display text-2xl text-gray-900 mb-4">
                  Our Mission
                </h2>
                <p className="text-lg text-gray-700 leading-relaxed">
                  Empowering 4 million youth across Africa by 2030 through inclusive, hands-on AI
                  and robotics education with locally fabricated solutions and sustainable
                  innovation.
                </p>
              </div>
            </div>
            <div className="mt-8 pt-8 border-t border-gray-200 ">
              <p className="text-gray-600 italic leading-relaxed">
                "Our 2025 achievements — 800+ learners, 66 Code Clubs, 13 PET recycling machines —
                are just the beginning. By 2030, we'll empower 4 million youth across Africa with
                inclusive AI and robotics education."
              </p>
              <div className="mt-5">
      ...
      <section className="relative overflow-hidden bg-gray-900 py-10 sm:py-16 scanlines circuit-grid">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          <p className="font-pixel text-teal-400 text-[0.6rem] sm:text-xs mb-4 tracking-widest">
            // 2026
          </p>
          ...
          <p className="text-lg sm:text-xl text-gray-300 mb-3 max-w-3xl mx-auto">
            Join the waitlist now. When the cycle opens you register, work the curriculum, build
            your team project, and have it judged at the National Showcase.
          </p>
          <p className="text-base text-gray-400 mb-10 max-w-2xl mx-auto">
            Nothing to pay to join. Registration is KES 2,000 per school — covering entry, the
            dashboard, the curriculum and judging.
          </p>
