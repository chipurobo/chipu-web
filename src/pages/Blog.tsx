      ...
      <section className="relative overflow-hidden bg-warm-50 dark:bg-gray-900 border-b border-warm-200 dark:border-gray-800">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-28 lg:py-32">
          <div className="text-center">
            <BookOpen className="h-12 w-12 text-terracotta-600 dark:text-terracotta-400 mx-auto mb-6" aria-hidden="true" />
            <h1 className="heading-display text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-4 tracking-tight">Our Blog</h1>
            ...
            {blogPosts.map((post) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <Link
                    to={`/blog/${post.id}`}
                    className="inline-flex items-center text-terracotta-600 dark:text-terracotta-400 hover:text-terracotta-700 dark:hover:text-terracotta-300 font-medium text-sm transition-colors"
                  >
                    Read More
