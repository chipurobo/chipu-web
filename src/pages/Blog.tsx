...
const Blog = () => {
 ...
 <BookOpen className="h-12 w-12 text-terracotta-600 mx-auto mb-6" aria-hidden="true" />
 <h1 className="heading-display text-4xl md:text-5xl font-bold text-gray-900 mb-4 tracking-tight">Our Blog</h1>
 ...
 <article
 key={post.id}
 className="group bg-white rounded-xl shadow-soft-md border border-gray-100 overflow-hidden transition-all duration-300 hover:-translate-y-1.5 hover:shadow-soft-lg"
 >
