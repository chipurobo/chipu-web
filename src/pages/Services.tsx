...
const Services = () => {
 ...
 {/* Hero Section */}
 <section
 className="relative overflow-hidden bg-warm-50 border-b border-warm-200 "
 ...
 className="heading-display text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 tracking-tight"
 >
 Our Programs
 </h1>
 ...
 <h2 id="main-programs-title" className="heading-display text-3xl font-bold text-gray-900 mb-4">
 Featured <span className="text-gray-400 ">Programs</span>
 </h2>
 ...
 <article
 key={index}
 className="group relative bg-white rounded-xl shadow-soft-md border border-gray-100 overflow-hidden transition-all duration-300 hover:-translate-y-1.5 hover:shadow-soft-lg"
 ...
 <program.icon className="h-7 w-7 text-teal-600 " aria-hidden="true" />
 </div>
 <h3 id={`program-title-${index}`} className="text-xl font-semibold text-gray-900 ">
 {program.title}
 </h3>
 </div>
 ...
 <div className="bg-green-100 p-0.5 rounded-full mr-3 mt-1.5 flex-shrink-0">
 <ChevronRight className="h-3 w-3 text-green-600 " aria-hidden="true" />
 </div>
 ...
 <Clock className="h-4 w-4 mr-2 text-teal-600 " aria-hidden="true" />
 <span className="text-xs">{program.duration}</span>
 </div>
 <div className="flex items-center text-gray-500 ">
 <Users className="h-4 w-4 mr-2 text-teal-600 " aria-hidden="true" />
 ...
 <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
 <div className="text-center mb-16">
 <h2 className="heading-display text-3xl font-bold text-gray-900 mb-4">Additional <span className="text-gray-400 ">Workshops</span></h2>
 <p className="text-lg text-gray-600 ">
 ...
 <p className="text-teal-600 font-medium text-sm">{workshop.schedule}</p>
 </div>
 ))}
 </div>
 </div>
 ...
 <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
 <div className="text-center mb-16">
 <h2 className="heading-display text-3xl font-bold text-gray-900 mb-4">Why Choose Our <span className="text-gray-400 ">Programs</span>?</h2>
 <p className="text-lg text-gray-600 ">
