...
const Bootcamps = () => {
 ...
 <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-4 heading-display text-gray-900 ">
 Bootcamps
 </h1>
 ...
 <div className="inline-flex items-center bg-teal-50 border border-teal-200 px-4 py-2 rounded-full text-teal-700 text-sm font-medium mb-4">
 <Cpu className="h-4 w-4 mr-2" aria-hidden="true" />
 Active Program
 </div>
 <h2 id="adc-program-title" className="text-3xl font-bold text-gray-900 mb-4 heading-display">
 ...
 <div
 key={stat.label}
 className="bg-white rounded-xl p-6 shadow-soft-md border border-gray-100 text-center transition-all duration-300 hover:shadow-soft-lg hover:-translate-y-1.5"
 >
 ...
 {/* Sessions */}
 <h3 className="text-2xl font-bold text-gray-900 mb-8 text-center heading-display">
 2025 Sessions
 </h3>
 ...
 <article
 key={session.label}
 className="bg-white rounded-xl p-6 shadow-soft-md border border-gray-100 transition-all duration-300 hover:shadow-soft-lg hover:-translate-y-1.5"
 >
 ...
 <Link
 to="/microsoft"
 className="group inline-flex items-center text-teal-600 hover:text-teal-700 font-medium transition-colors"
 >
 ...
 {/* ===== CURRICULUM ===== */}
 <section className="section-alt bg-warm-100 " aria-labelledby="curriculum-title">
 <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
 <div className="text-center mb-16">
 <h2 id="curriculum-title" className="text-3xl font-bold text-gray-900 mb-4 heading-display">
 What Learners Build
 </h2>
 ...
 <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
 <div className="text-center mb-16">
 <h2 id="how-it-works-title" className="text-3xl font-bold text-gray-900 mb-4 heading-display">
 ...
 <div className="bg-white rounded-xl p-8 shadow-soft-md border border-gray-100 text-center">
 <div className="w-12 h-12 rounded-full bg-teal-50 flex items-center justify-center mx-auto mb-4">
 <span className="text-xl font-bold text-teal-600 ">1</span>
 </div>
 <h3 className="text-lg font-semibold text-gray-900 mb-2">Partner & Plan</h3>
 ...
 <h3 className="text-lg font-semibold text-gray-900 mb-2">Build & Learn</h3>
 <p className="text-sm text-gray-600 ">
 ...
 <h3 className="text-lg font-semibold text-gray-900 mb-2">Demo & Certify</h3>
 <p className="text-sm text-gray-600 ">
 ...
 {/* ===== PARTNER WITH US CTA ===== */}
 <section
 className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-gray-900 to-gray-900 "
