...
const NotFound = () => {
  return (
    <div className="min-h-[60vh] flex items-center justify-center px-4 bg-warm-50 dark:bg-gray-900">
      <div className="text-center">
        <h1 className="text-8xl font-bold tracking-tight text-primary-600 dark:text-primary-400 mb-4 heading-display">404</h1>
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white mb-4 heading-display">Page Not Found</h2>
