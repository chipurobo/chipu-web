    ...
    <div className="bg-warm-50 dark:bg-gray-900">
      ...
      <section className="relative overflow-hidden bg-warm-50 dark:bg-gray-900 border-b border-warm-200 dark:border-gray-800">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
          <div className="max-w-3xl">
            <div className="inline-flex items-center bg-white dark:bg-gray-800 border border-warm-200 dark:border-gray-700 px-4 py-1.5 rounded-full text-sm text-gray-700 dark:text-gray-300 mb-6">
              <span className="font-pixel text-[0.55rem] tracking-widest text-terracotta-600 dark:text-terracotta-400 mr-3">HACK</span>
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black tracking-tight leading-none mb-4 heading-display">
              <span className="text-teal-600 dark:text-teal-400">BRAILLE</span>{' '}
              <span className="text-gray-900 dark:text-white">CHALLENGE</span>
            </h1>

            <p className="text-xl md:text-2xl font-bold text-gray-700 dark:text-gray-200 tracking-wide mb-6">
              BUILD. <span className="text-teal-600 dark:text-teal-400">INCLUDE.</span> EMPOWER.
            </p>
            ...
            <div className="flex flex-wrap gap-3 mb-10">
              <span className="inline-flex items-center bg-white dark:bg-gray-800 border border-warm-200 dark:border-gray-700 px-4 py-2 rounded-lg text-sm text-gray-800 dark:text-white">
                <Calendar className="h-4 w-4 mr-2 text-teal-600 dark:text-teal-400" /> May 14–15, 2026
              </span>
              <span className="inline-flex items-center bg-white dark:bg-gray-800 border border-warm-200 dark:border-gray-700 px-4 py-2 rounded-lg text-sm text-gray-800 dark:text-white">
                <Clock className="h-4 w-4 mr-2 text-teal-600 dark:text-teal-400" /> 8:00 AM – 4:00 PM daily
              </span>
              <span className="inline-flex items-center bg-white dark:bg-gray-800 border border-warm-200 dark:border-gray-700 px-4 py-2 rounded-lg text-sm text-gray-800 dark:text-white">
                <MapPin className="h-4 w-4 mr-2 text-terracotta-600 dark:text-terracotta-400" /> Railways Museum, Nairobi
              </span>
              <span className="inline-flex items-center bg-white dark:bg-gray-800 border border-warm-200 dark:border-gray-700 px-4 py-2 rounded-lg text-sm text-gray-800 dark:text-white">
                <Users className="h-4 w-4 mr-2 text-teal-600 dark:text-teal-400" /> Teams of 3–5
              </span>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center bg-terracotta-50 dark:bg-red-500/10 border border-terracotta-200 dark:border-red-500/20 px-5 py-3 rounded-lg">
                <AlertTriangle className="h-4 w-4 text-terracotta-600 dark:text-red-400 mr-2 flex-shrink-0" />
                <span className="text-sm text-terracotta-700 dark:text-red-300 font-medium">Deadline: May 12, 2026</span>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 sm:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-3 text-center heading-display">Hackathon Tracks</h2>
      ...
      <section className="py-20 sm:py-28 bg-gray-50 dark:bg-gray-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-3 text-center heading-display">2-Day Schedule</h2>
          ...
          <div className="grid gap-6 md:grid-cols-2 max-w-4xl mx-auto">
            {schedule.map((day) => (
              <div key={day.day} className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-100 dark:border-gray-700/50">
                <h3 className="text-lg font-semibold text-teal-600 dark:text-teal-400 mb-4">{day.day}</h3>
      ...
      <section className="py-20 sm:py-28">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-12 text-center heading-display">Frequently Asked Questions</h2>
      ...
      <section className="py-16 sm:py-20 bg-gray-50 dark:bg-gray-800/50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-4 text-center heading-display">Code of Conduct</h2>
      ...
      {/* CTA / Register */}
      <section className="relative overflow-hidden bg-gray-900 py-20 sm:py-28 scanlines circuit-grid">
